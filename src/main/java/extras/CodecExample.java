...
public class CodecExample {
  ...
  private List<Document> createDocs() {
    ...
    doc1.add(new Field("summary",
        "Java 7 has a number of features that will please developers. Madhusudhan Konda provides an overview of " +
            "these, including strings in switch statements, multi-catch exception handling, try-with-resource " +
            "statements, the new File System API, extensions of the JVM, support for dynamically-typed languages, and" +
    ...
    doc2.add(new Field("summary",
        "Fully updated for Java Platform, Standard Edition 8 (Java SE 8), Java: A Beginner's Guide, Sixth Edition " +
            "gets you started programming in Java right away. Bestselling programming author Herb Schildt begins with" +
            " the basics, such as how to create, compile, and run a Java program. He then moves on to the keywords, " +
            "syntax, and constructs that form the core of the Java language. This Oracle Press resource also covers " +
            "some of Java's more advanced features, including multithreaded programming, generics, and Swing. Of " +
            "course, new Java SE 8 features such as lambda expressions and default interface methods are described. " +
            "An introduction to JavaFX, Java's newest GUI, concludes this step-by-step tutorial.",
        summaryType));
    ...
    doc3.add(new Field("summary",
        "Are you looking for a deeper understanding of the Java™ programming language so that you can write code that" +
            " is clearer, more correct, more robust, and more reusable? Look no further! Effective Java™, Second " +
            "Edition, brings together seventy-eight indispensable programmer’s rules of thumb: working, best-practice" +
            " solutions for the programming challenges you encounter every day. This highly anticipated new edition " +
            "of the classic, Jolt Award-winning work has been thoroughly updated to cover Java SE 5 and Java SE 6 " +
            "features introduced since the first edition. Bloch explores new design patterns and language idioms, " +
            "showing you how to make the most of features ranging from generics to enums, annotations to autoboxing. " +
            "Each chapter in the book consists of several “items” presented in the form of a short, standalone essay " +
            "that provides specific advice, insight into Java platform subtleties, and outstanding code examples. The" +
            " comprehensive descriptions and explanations for each item illuminate what to do, what not to do, and " +
            "why.",
        summaryType));
    ...
    doc4.add(new Field("summary",
        "DESCRIPTION Even though running batch processes is an everyday task in almost all IT departments, Java " +
            "developers have had few options for writing batch applications. The result? No standards, poor code " +
            "reusability, numerous in-house solutions, and lots of frustrated developers. Jointly developed by " +
            "SpringSource and Accenture, Spring Batch fills this critical gap by providing a robust and convenient " +
            "framework for writing batch applications that process large volumes of information, automate repetitive " +
            "tasks, and synchronize internal systems. Spring Batch in Action is a comprehensive, in-depth guide to " +
            "writing batch applications using Spring Batch. Written for developers who have basic knowledge of Java " +
            "and the Spring lightweight container, it provides both a best-practices approach to writing batch jobs " +
            "and comprehensive coverage of the Spring Batch framework. KEY POINTS * Complete guide to the Spring " +
            "Batch framework * Numerous real-world examples * Covers basics, best practices and advanced topics",
        summaryType));
    ...
    doc5.add(new Field("summary",
        "Introduction to Data Mining presents fundamental concepts and algorithms for those learning data mining for " +
            "the first time. Each major topic is organized into two chapters, beginning with basic concepts that " +
            "provide necessary background for understanding each data mining technique, followed by more advanced " +
    ...
    doc6.add(new Field("summary",
        "DESCRIPTION Functional programming (FP) is a programming style emphasizing functions that return consistent " +
            "and predictable results regardless of a program's state. As a result, functional code is easier to test " +
            "and reuse, simpler to parallelize, and less prone to bugs. Scala is an emerging JVM language that offers" +
            " strong support for FP. Its familiar syntax and transparent interoperability with existing Java " +
            "libraries make Scala a great place to start learning FP. Functional Programming in Scala is a serious " +
            "tutorial for programmers looking to learn FP and apply it to the everyday business of coding. The book " +
            "guides readers from basic techniques to advanced topics in a logical, concise, and clear progression. In" +
            " it, they'll find concrete examples and exercises that open up the world of functional programming. " +
            "RETAIL SELLING POINTS Covers the practical benefits of Functional Programming Offers concrete examples " +
            "and exercises Logically progresses from basic techniques to advance topics AUDIENCE No prior experience " +
            "with FP or Scala is required. Perfect for programmers familiar with FP in other languages wishing to " +
            "apply their knowledge in Scala. ABOUT THE TECHNOLOGY Functional programming (FP) is a programming style " +
            "emphasizing functions that return consistent and predictable results regardless of a program's state. " +
